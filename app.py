...
#     response = requests.post('http://k8-assignment-container2-service/sum', json={"file": file_name, "product": product})
...
def calculate():
    ...
    response = requests.post(url="http://k8-assignment-container2-service/sum", json=request.json, headers={'Content-Type': 'application/json'})
